...
public class LoadRecipes {
    ...
    public void loadRecipes() {
        ...
        for (String recipeName : localRecipes) loadRecipe(recipeName);
    ...
    public void loadRecipe(String recipeName){
        ...
        if (!configLoader.getEnabled(recipeName)) return;
            ...
            case "furnace":
                ...
                if (!furnaceMaterial.isAir()) {
                    FurnaceRecipe furnaceRecipe =
                            new FurnaceRecipe(
                                    new NamespacedKey(plugin, recipeName.toLowerCase()),
                                    result,
                                    furnaceMaterial,
                                    furnaceExperience,
                                    furnaceCookTime);
        ...
        Permission permission =
                new Permission(
                        "pintorecipes.craft." + recipeName,
                        "Permission to craft the recipe " + recipeName,
