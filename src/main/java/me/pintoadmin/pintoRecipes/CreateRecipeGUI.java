...
public class CreateRecipeGUI {
                    ...
                    if (shapedRecipe == null) {
                        ...
                        for (Map<String, String> recipeMap : shapedRecipe) {
                            for (int i = 0; i < 3; i++) {
                                ...
                                String value = null;
                                if (round % 3 == 1) value = recipeMap.get("left");
                                if (round % 3 == 2) value = recipeMap.get("middle");
                                if (round % 3 == 0) value = recipeMap.get("right");
    ...
    private void updateTypeIcon() {
        ...
        typeSelectMeta.setLore(
                List.of(
                        color("&d&lLeft click to select next"),
                        color("&d&lRight click to select previous")));
        typeSelectMeta
                .getPersistentDataContainer()
                .set(idNameKey, PersistentDataType.STRING, "typeSelectItem");
    ...
    private void updateLimitIcon() {
        ...
        limitSelectMeta.setLore(
                List.of(
                        color("&r&7Type: " + getCurrentLimitType()),
                        color("&r&7Number: " + getCurrentLimitNumber()),
                        color("&d&lLeft or right click to switch type"),
                        color("&d&lShift-left click to increment number"),
                        color("&d&lShift-right click to decrement number")));
        limitSelectMeta
                .getPersistentDataContainer()
        ...
        switch (type) {
            case "shaped":
                ...
                for (Integer index : craftingSlots) {
                    ...
                    shapedMaterials[craftingSlots.indexOf(index)] =
            ...
            case "shapeless":
                ...
                for (Integer index : craftingSlots) {
                    ...
                    if (meta != null) {
                        ...
                        String value = container.get(idNameKey, PersistentDataType.STRING);
                        if (value != null) {
                            if (value.equals("unused_space")) continue;
                        }
                    }
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        if (event.getCurrentItem() != null) {
            ...
            String idKey =
                    meta.getPersistentDataContainer().get(idNameKey, PersistentDataType.STRING);
